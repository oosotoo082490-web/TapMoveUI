          ...
          <div className="space-y-12">
            ...
            <div className="bg-gradient-to-br from-stone-800/90 to-stone-700/90 backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-amber-500/20 hover:border-amber-400/30 transition-all duration-300">
              ...
              <p className="text-white leading-relaxed text-lg font-medium">
                ...
                특히 노인복지 수업에서, <strong className="text-white font-bold">운동을 원하지만 관절의 부담 때문에 참여하지 못하는 분들</strong>이 많다는 현실을 발견했습니다.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-stone-800/90 to-stone-700/90 backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-amber-500/20 hover:border-amber-400/30 transition-all duration-300">
              ...
              <p className="text-white leading-relaxed text-lg font-medium">
                ...
                운동의 필요성은 크지만 <strong className="text-white font-bold">마땅한 대안이 없는 상황</strong>이 안타까웠습니다.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-stone-800/90 to-stone-700/90 backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-amber-500/20 hover:border-amber-400/30 transition-all duration-300">
              ...
              <p className="text-white leading-relaxed text-lg font-medium">
                ...
                그 해답을 찾는 과정에서 <strong className="text-white font-bold">'탭무브'</strong>가 탄생했습니다.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-stone-800/90 to-stone-700/90 backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-amber-500/20 hover:border-amber-400/30 transition-all duration-300">
              ...
              <ul className="space-y-4 text-white text-lg">
                <li className="flex items-start">
                  ...
                  <span className="font-medium">단 6mm의 얇은 매트 위에서 <strong className="text-white font-bold">안전하고 부담 없는 움직임</strong></span>
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-3 h-3 bg-gradient-to-r from-amber-400 to-amber-500 rounded-full mt-2.5 mr-5 flex-shrink-0 shadow-lg"></span>
                  <span className="font-medium"><strong className="text-white font-bold">밸런스·순발력·유산소 효과</strong>를 동시에 고려한 설계</span>
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-3 h-3 bg-gradient-to-r from-amber-400 to-amber-500 rounded-full mt-2.5 mr-5 flex-shrink-0 shadow-lg"></span>
                  <span className="font-medium">단순한 대안이 아닌, <strong className="text-white font-bold">새로운 카테고리의 시작</strong></span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-stone-800/90 to-stone-700/90 backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-amber-500/20 hover:border-amber-400/30 transition-all duration-300">
              ...
              <p className="text-white leading-relaxed text-lg font-medium">
                탭무브는 단순한 도구가 아닙니다. 
                <strong className="text-white font-bold">운동의 기회를 넓히고, 누구나 자신 있게 움직일 수 있도록 돕는 새로운 문화</strong>입니다.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-stone-900/60 to-stone-800/60 backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-stone-500/30">
            ...
            <div className="mb-8">
              <p className="text-white text-xl leading-relaxed mb-6 text-center font-medium">
                ⚖️ <strong className="text-white font-bold">TAPMOVE는 상표법에 따라 정식 등록된 상표</strong>입니다.
              </p>
            </div>
