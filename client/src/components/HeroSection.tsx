      ...
      <div className="container mx-auto px-4 text-center max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-stone-900/80 rounded-2xl p-8 shadow-xl border border-stone-700 text-center">
            ...
            <p className="text-stone-300 text-sm leading-relaxed">전문가 직접 지도하는<br />세미나</p>
          </div>
          <div className="bg-stone-900/80 rounded-2xl p-8 shadow-xl border border-stone-700 text-center">
            <div className="text-4xl mb-4">📦</div>
            <h3 className="text-lg font-semibold text-emerald-400 mb-3">실용적 제품</h3>
            <p className="text-stone-300 text-sm leading-relaxed">검증된 TAPMOVE<br />전용 장비</p>
          </div>
        </div>
      </div>
