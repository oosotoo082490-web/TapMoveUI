      ...
      <div className="container mx-auto px-4 text-center max-w-5xl">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
          <Button
            ...
            className="bg-gradient-to-r from-red-900 to-red-800 hover:from-red-800 hover:to-red-700 text-white px-10 py-5 rounded-2xl text-xl font-semibold transition-all duration-300 transform hover:scale-105 shadow-xl border border-red-700"
            size="lg"
          >
            세미나 신청하기
